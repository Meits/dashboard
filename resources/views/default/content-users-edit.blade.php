...
<form class="form-horizontal" role="form" method="POST" action="{{ route('users_update',array('user'=>$user->id)) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('birthday') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="birthday" type="text" class="form-control" name="birthday" value="{{ $user->birthday }}" required autofocus>
                        ...
                        @if($canRole) 
                        	 ...
                        	 <div class="form-group{{ $errors->has('zip') ? ' has-error' : '' }}">
	                            <label for="zip" class="col-md-4 control-label">Role</label>
                        ...
                        @else
                        	<div class="form-group{{ $errors->has('zip') ? ' has-error' : '' }}">
                        		 <label for="zip" class="col-md-4 control-label">Role</label>
                        		<div class="col-md-6">
                        			<p>{{ is_object($user->roles()->first()) ? $user->roles->first()->name : ''}}</p>
                        		</div>
                        	</div>
